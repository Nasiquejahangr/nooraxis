...
import { Mail, MapPin, Phone, MessageCircle, Send, Loader2, CheckCircle2, Sparkles, Navigation } from "lucide-react";
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center pt-6 md:pt-12 pb-20 px-6 overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-5xl text-center relative z-10">
          ...
          >
            ...
            <span className="text-xs font-semibold tracking-[0.15em] uppercase">Interactive Channels</span>
          </motion.div>
          ...
          >
            Formulate your software ideas. Reach out to our architects to discuss your technical parameters and budget pipelines.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            >
              <div className="glass-dark border border-gray-200 dark:border-white/5 rounded-3xl p-8 bg-white/60 dark:bg-[#03050c]/40 relative overflow-hidden">
                ...
                <h3 className="text-xl font-heading font-bold mb-6 text-gray-900 dark:text-white flex items-center gap-2">
                  <Navigation size={18} className="text-brand-accent animate-pulse" /> Contact Directory
                </h3>
                
                <div className="space-y-6">
                  {[
                    { icon: Mail, label: "Email Correspondence", value: "nasiquejahangir000@gmail.com", href: "mailto:nasiquejahangir000@gmail.com" },
                    { icon: Phone, label: "Direct Phone Link", value: "+91 9508904653", href: "tel:+919508904653" },
                    ...
                    <div key={label} className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-xs font-bold uppercase tracking-wider text-gray-500 mb-1">{label}</h4>
                        <a href={href} className="text-sm font-semibold text-gray-800 dark:text-gray-300 hover:text-brand-accent transition-colors">
                          {value}
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="flex items-start gap-4 pt-2 border-t border-black/5 dark:border-white/5">
                    ...
                    <div>
                      <h4 className="text-xs font-bold uppercase tracking-wider text-gray-500 mb-1">HQ Physical Location</h4>
                      <p className="text-sm text-gray-800 dark:text-gray-300 leading-relaxed font-semibold">
                        Madhopara, Islam Nagar, Purnia<br />
                        Bihar, India
                      </p>
                    </div>
                  </div>
              ...
              <div className="w-full h-64 rounded-3xl overflow-hidden border border-gray-250 dark:border-white/5 flex items-center justify-center relative bg-gray-50 dark:bg-[#03050c]/60 backdrop-blur-md shadow-sm group">
                ...
                <div className="z-10 text-center space-y-2">
                  ...
                  <p className="text-xs font-bold text-gray-800 dark:text-gray-300 uppercase tracking-wider">Coordinates Calibrated</p>
                  <p className="text-[10px] text-gray-500 font-mono">Purnia, Bihar (India)</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="p-8 sm:p-10 rounded-3xl border border-gray-200 dark:border-white/5 relative overflow-hidden bg-white/60 dark:bg-[#03050c]/40 backdrop-blur-md">
                ...
                <h3 className="text-2xl font-heading font-extrabold mb-6 relative z-10 text-gray-900 dark:text-white tracking-tight">Send Enquiry</h3>
                ...
                <form className="relative z-10 space-y-5" onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold uppercase tracking-wider text-gray-500">Scope of Work</label>
                    <select
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold uppercase tracking-wider text-gray-500">Project Brief</label>
                    <textarea
                      rows={4}
                  ...
                  >
                    {isSubmitting ? (
                      <>
                        <Loader2 size={16} className="animate-spin" /> Transmitting parameters...
                      </>
                    ) : (
                      <>
                        Submit Enquiry <Send size={15} className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 duration-200" />
                      </>
                    )}
                  </button>
                </form>
                ...
                <AnimatePresence>
                  {isSuccess && (
                    ...
                    >
                      ...
                      <h4 className="text-xl font-heading font-extrabold mb-2 text-gray-900 dark:text-white">Parameters Received!</h4>
                      <p className="text-gray-600 dark:text-gray-400 text-xs max-w-sm mb-8 leading-relaxed font-semibold">
                        Thank you for reaching out. We have logged your enquiry in our operations queue and our engineering team will get back to you shortly.
                      </p>
                      <button
                ...
                <div className="mt-8 pt-6 border-t border-black/5 dark:border-white/5 text-center">
                  <p className="text-xs text-gray-500 mb-4 font-semibold">Prefer instant voice consultation?</p>
                  <a 
