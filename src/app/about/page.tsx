...
import { CheckCircle2, Target, Lightbulb, Users, Sparkles, ShieldCheck, HeartHandshake } from "lucide-react";
    ...
    <div className="flex flex-col w-full overflow-hidden tech-grid min-h-screen">
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center pt-6 md:pt-12 pb-20 px-6 overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl text-center relative z-10">
          ...
          >
            <span className="text-xs font-semibold tracking-[0.15em] uppercase font-mono">Our Identity</span>
          </motion.div>
          ...
          >
            We don't write generic, clinical lines of code or construct automated templates. We are a tightly knit collective of senior designers, engineers, and product builders obsessed with layout fidelity, clean engineering architecture, and direct transparency. We craft custom digital systems built to endure and inspire.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            >
              ...
              <div>
                ...
                <h3 className="text-2xl font-heading font-bold mb-4 text-gray-900 dark:text-white">Our Mission</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
                  To eliminate digital mediocrity by engineering custom, high-performance web systems. We exist to replace standard cookie-cutter frameworks with deep, deliberate digital design, ensuring our clients receive transparent collaboration and senior-level execution.
                </p>
              </div>
            ...
            >
              ...
              <div>
                ...
                <h3 className="text-2xl font-heading font-bold mb-4 text-gray-900 dark:text-white">Our Vision</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
                  To establish a new standard where digital products are treated with the respect of physical craftsmanship. We envision a modern web where speed is instantaneous, interface elements feel alive, and clean codebase health is never sacrificed for speed of delivery.
                </p>
              </div>
      ...
      <section className="py-24 bg-gray-50 dark:bg-[#070b16] transition-colors duration-500 relative overflow-hidden border-y border-gray-100 dark:border-white/5">
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          <motion.div {...fadeIn} className="text-center mb-20 max-w-3xl mx-auto">
            <span className="text-xs font-semibold tracking-[0.2em] text-brand-blue dark:text-brand-accent uppercase mb-3 block font-mono">Real-World Principles</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-extrabold text-gray-900 dark:text-white">What We Stand For</h2>
            <p className="text-gray-600 dark:text-gray-400 text-base max-w-xl mx-auto mt-2">
              We operate on simple, uncompromising human principles that ensure high-integrity collaboration and beautiful digital delivery.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { 
                ...
                color: "text-brand-accent bg-brand-accent/10 border-brand-accent/15" 
              },
              { 
                icon: ShieldCheck, 
              ...
              >
                <div className={`w-16 h-16 mx-auto rounded-2xl flex items-center justify-center mb-6 border ${value.color}`}>
                  <value.icon size={26} />
                </div>
                <h4 className="text-xl font-heading font-bold mb-3 text-gray-900 dark:text-white">{value.title}</h4>
      ...
      <section className="py-24 bg-white dark:bg-transparent transition-colors duration-500 relative">
        <div className="container mx-auto px-6 max-w-4xl relative z-10">
          <motion.div {...fadeIn} className="text-center mb-20 max-w-2xl mx-auto">
            <span className="text-xs font-semibold tracking-[0.2em] text-brand-blue dark:text-brand-accent uppercase mb-3 block font-mono">Our Timeline</span>
            <h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white">The Nooraxis Story</h2>
          </motion.div>
              ...
              >
                ...
                <div className="glass-dark border border-gray-200 dark:border-white/5 rounded-3xl p-8 bg-white/50 dark:bg-[#03050c]/50 hover:border-brand-blue/30 transition-colors">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="font-mono text-xs font-bold text-brand-accent bg-brand-blue/10 dark:bg-brand-blue/20 border border-brand-blue/15 px-3 py-1 rounded-full">{step.year}</span>
                    <h4 className="text-xl font-heading font-extrabold text-gray-900 dark:text-white">{step.title}</h4>
                  </div>
